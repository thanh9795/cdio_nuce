...
<script>
	$(document).ready(function() {
		$(".itemdelete").click(function(event) {
			...
			if (del) {
				window.location.assign('<?= base_url("index.php/page/deleteMenuElement/") ?>'+$(this).data('id'));
			}
		});
					...
					<div class="panel panel-default">
						...
						<div id="collapse1" class="panel-collapse collapse in">
							<div class="panel-body">
								<form method="POST" action="<?=base_url('index.php/page/addMenuElement')?>" class="form-horizontal form-label-left input_mask">
